...
export function buildPrompt(
  ...
  parts.push(
    '\n[체크리스트]\n' +
      ...
      '- 축구 전용 가이드: (1) 암묵확률(1/배당)에 비해 과대확신하지 말고 ±0.1 이내에서만 조정하세요. (2) 승무패는 HOME/DRAW/AWAY 합이 1이 되도록 내부적으로 일관된 확률을 생각하고, DRAW 기본 prior를 0.25~0.35로 유지하세요. (3) 홈 강팀이라도 probability 0.72 이상은 피하고, 접전 징후가 있으면 0.6 미만으로 캡핑하세요. (4) 원정 연전·장거리 이동·기후 불리 시 언더/핸디 또는 DRAW로 전환을 우선 검토하세요.',
  );
  parts.push(
